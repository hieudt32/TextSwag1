...
package com.example.baotu.textswag.cropper;
...
import com.example.baotu.textswag.activity.CropActivity;
...
public final class CropImage {
    ...
    /**
     * The key used to pass crop image source URI to {@link com.example.baotu.textswag.activity.CropActivity}.
     */
    public static final String CROP_IMAGE_EXTRA_SOURCE = "CROP_IMAGE_EXTRA_SOURCE";

    /**
     * The key used to pass crop image options to {@link com.example.baotu.textswag.activity.CropActivity}.
     */
    public static final String CROP_IMAGE_EXTRA_OPTIONS = "CROP_IMAGE_EXTRA_OPTIONS";

    /**
     * The key used to pass crop image result data back from {@link com.example.baotu.textswag.activity.CropActivity}.
     */
    ...
    /**
     * The request code used to start {@link com.example.baotu.textswag.activity.CropActivity} to be used on result to identify the this specific
     * request.
     */
    public static final int CROP_IMAGE_ACTIVITY_REQUEST_CODE = 203;

    /**
     * The result code used to return error from {@link com.example.baotu.textswag.activity.CropActivity}.
     */
    ...
    public static Intent getPickImageChooserIntent(@NonNull Context context) {
        return getPickImageChooserIntent(context, "", false);
    }
    ...
    /**
     * Create {@link ActivityBuilder} instance to start {@link com.example.baotu.textswag.activity.CropActivity} to crop the given image.<br>
    ...
    /**
     * Get {@link com.example.baotu.textswag.activity.CropActivity} result data object for crop image activity started using {@link #activity(Uri)}.
     *
    ...
    public static final class ActivityBuilder {
        ...
        /**
         * Get {@link com.example.baotu.textswag.activity.CropActivity} intent to start the activity.
         */
...
//            intent.putExtra("Image", imgFrame);
        ...
        /**
         * Start {@link com.example.baotu.textswag.activity.CropActivity}.
         *
        ...
        /**
         * the title of the {@link com.example.baotu.textswag.activity.CropActivity}.<br>
         * <i>Default: ""</i>
         */
