...
//                    ta.recycle();
        ...
        frLoading = (FrameLayout) v.findViewById(R.id.frLoading);
        imgLoading = (ImageView) v.findViewById(R.id.imgLoading);
    ...
    /**
     * LinhNBV - Get bitmap of image attach to ImageView
     *
     * @return
     */
    ...
    private void setProgressBarVisibility() {
        ...
        Animation animLoading = AnimationUtils.loadAnimation(getContext(), R.anim.anim_rotate_loading);

        boolean visible = mShowProgressBar &&
                (mBitmap == null && mBitmapLoadingWorkerTask != null || mBitmapCroppingWorkerTask != null);
        if (visible) {
            frLoading.setVisibility(VISIBLE);
            imgLoading.startAnimation(animLoading);

        } else {
            animLoading.cancel();
            frLoading.setVisibility(INVISIBLE);
